...
df = pd.read_csv("C:/Users/Carsen Rae Helms/OneDrive/Desktop from Surface Pro/Portfolio/Global MH Disorder Trends/data/processed/top10_avg_depression.csv")
...
plt.savefig("../images/global_depression_top102.png", dpi=300)
plt.show()